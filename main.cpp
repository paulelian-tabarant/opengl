...
int main(int argc, char *argv[])
{
	...
	char imagePath[] {"Images/appartment.hdr"};
	ImageBasedLighting ibl(imagePath, 5);
    ...
    objectModel = std::make_unique<Model>("Models/batman/batman.obj");
	objectModel->setPosition(0.0f, 0.0f, -2.0f);
