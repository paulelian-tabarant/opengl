...
private:
    ...
    const std::string diffuseMapPath {"diffusemap.png"};
    const std::string specularMapPath {"specularmap.png"};
...
public:
    ...
    void setMaterial(float shin = 64.0f)
    {
        shininess = shin;
    }
    ...
    void writeToShader(Shader &shader)
    {
        ...
        shader.use();
        shader.setInt(diffuseStr, 0);
        glActiveTexture(GL_TEXTURE0);
        glBindTexture(GL_TEXTURE_2D, diffuseMap);
        shader.setInt(specularStr, 1);
